...
class _CharacterCardEditorScreenState extends State<CharacterCardEditorScreen> {
  ...
  Widget _textField(
    ...
    return Stack(
      children: [
        Padding(
          padding: EdgeInsets.only(top: 0, right: fullscreen ? 36 : 0),
          child: TextField(
        ...
        if (fullscreen)
          Positioned(
            ...
            child: IconButton(
              ...
              tooltip: context.read<LocaleProvider>().l10n.tr('fullscreen_edit'),
              onPressed: () => _openFullscreen(label, controller),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            _section(l10n.tr('char_name'), _textField(l10n.tr('char_name'), _nameCtrl, minLines: 1, maxLines: 2)),
            _section(l10n.tr('char_description'), _textField(l10n.tr('char_description_hint'), _descCtrl, minLines: 6, maxLines: 12)),
            _section(l10n.tr('char_personality'), _textField(l10n.tr('char_personality_hint'), _personalityCtrl, minLines: 5, maxLines: 10)),
            _section(l10n.tr('char_scenario'), _textField(l10n.tr('char_scenario_hint'), _scenarioCtrl, minLines: 5, maxLines: 10)),
            _section(l10n.tr('char_first_mes'), _textField(l10n.tr('char_first_mes_hint'), _firstMesCtrl, minLines: 5, maxLines: 12)),
            _section(l10n.tr('char_mes_example'), _textField(l10n.tr('char_mes_example_hint'), _mesExampleCtrl, minLines: 6, maxLines: 14)),
            _section(l10n.tr('char_system_prompt'), _textField(l10n.tr('char_system_prompt'), _systemPromptCtrl, minLines: 4, maxLines: 10)),
            _section(l10n.tr('char_post_history_instructions'), _textField(l10n.tr('char_post_history_instructions'), _postHistoryCtrl, minLines: 4, maxLines: 10)),
            _section(l10n.tr('char_notes'), _textField(l10n.tr('char_notes'), _notesCtrl, minLines: 3, maxLines: 8)),
            // 元信息：作者 / 角色卡版本
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
              child: Row(
                children: [
                  Expanded(child: _textField(l10n.tr('char_creator'), _creatorCtrl, minLines: 1, maxLines: 1, fullscreen: false)),
                  const SizedBox(width: 12),
                  Expanded(child: _textField(l10n.tr('char_character_version'), _charVersionCtrl, minLines: 1, maxLines: 1, fullscreen: false)),
                ],
              ),
            ),
